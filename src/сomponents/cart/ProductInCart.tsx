...
import { thankDeleteProduct, deleteProduct, thankIncreaseQuantityInCart, thankDecreaseQuantityInCart } from "../../store/Slice/CartSlice"
    ...
    return(
        ...
        <div className="ProductInCart_information">
             ...
             <div className="ProductInCart_quantity_and_removal">
                <p onClick={()=>props.quantity === 0 ? null : dispatch(thankDecreaseQuantityInCart({ id: props.id, quantity: props.quantity - 1}))}>-</p>
                <input type="number" value={props.quantity} />
                <p onClick={()=> dispatch(thankIncreaseQuantityInCart({ id: props.id, quantity: props.quantity + 1}))}>+</p>
